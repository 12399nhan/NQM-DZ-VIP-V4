...
local Window = Fluent:CreateWindow({
    ...
    SubTitle = "[PREMIUM] True V4 by nhân",
    TabWidth = 160,
...
local Tabs = {
    ...
    Player = Window:AddTab({ Title = "Đánh nhau", Icon = "baby" }),
	...
	Misc = Window:AddTab({ Title = "Lặt vặt", Icon = "list-plus" }),
}
...
---------Tween
  ...
  function Tween2(P1)
    ...
    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/Speed, Enum.EasingStyle.Li), {
      CFrame = P1
    }):Play()
